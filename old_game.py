...
pygame.mixer.music.load(f"{DIR_PATH}\sounds\\theme.mp3")
pygame.mixer.music.play(loops=-1)

# dźwięk kolizji

explosion = pygame.mixer.Sound(f"{DIR_PATH}\sounds\explosion.mp3")
...
while running:
    ...
    draw_lives(screen, 10, 40, player.lives, f"{DIR_PATH}images\jetfighter.png") 
